module.exports = {
  ...
  rules: {
    ...
    'no-underscore-dangle': ['error', { allow: ['__REDUX_DEVTOOLS_EXTENSION__', '__REDUX_DEVTOOLS_EXTENSION_COMPOSE__', '_id'] }],
    'max-len': ['error', {
      code: 150, tabWidth: 2, ignoreStrings: true, ignoreComments: true,
    }],
